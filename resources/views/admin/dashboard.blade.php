    ...
    <div class="cards-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(226,75,74,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    <rect x="1" y="3" width="14" height="10" rx="2" stroke="#E24B4A" stroke-width="1.5"/>
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(29,158,117,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    ...
                    <path d="M6 8l1.5 1.5L11 6" stroke="#1D9E75" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(136,135,128,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    <path d="M2 13l4-4 3 3 5-6" stroke="#888780" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(239,159,39,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    <rect x="2" y="4" width="12" height="8" rx="2" stroke="#EF9F27" stroke-width="1.5"/>
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(99,153,34,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    <path d="M8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" stroke="#639922" stroke-width="1.5"/>
        ...
        <div class="stat-card">
            ...
            <div class="stat-icon" style="background:rgba(127,119,221,0.15)">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                    <path d="M2 12V4l6 4 6-4v8" stroke="#7F77DD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
    ...
    <div class="chart-section">
        ...
        <div style="position:relative; width:100%; height:260px;">
            <canvas id="revenueChart"
                role="img"
                aria-label="Biểu đồ doanh thu theo tháng trong năm">
...
(function () {
    const palette = [
        ...
        { bg: '#EF9F27', border: '#BA7517' },
        { bg: '#D4537E', border: '#993556' },
        { bg: '#5DCAA5', border: '#1D9E75' },
        { bg: '#E24B4A', border: '#A32D2D' },
        { bg: '#85B7EB', border: '#378ADD' },
        { bg: '#639922', border: '#3B6D11' },
        { bg: '#F09595', border: '#E24B4A' },
        { bg: '#AFA9EC', border: '#7F77DD' },
        { bg: '#FAC775', border: '#EF9F27' },
    ];
    ...
    new Chart(document.getElementById('revenueChart'), {
        ...
        options: {
            ...
            scales: {
                x: {
                    ticks: { color: 'rgba(255,255,255,0.4)', font: { size: 12 }, autoSkip: false },
                    grid: { display: false },
