  ...
  <div class="container-fluid px-3 px-md-5">
    ...
    <form method="POST" action="{{ route('admin.actors.store') }}" enctype="multipart/form-data">
      ...
      <div class="cw-card">
        <div class="row g-4">
          <div class="col-md-8">
            ...
            <input type="text" id="name" name="name" class="cw-input" value="{{ old('name') }}" placeholder="Nhập tên diễn viên" required>
          ...
          <div class="col-md-4">
            ...
            <div class="cw-image-card">
              <img id="preview" class="cw-img-preview" src="https://static.vecteezy.com/system/resources/thumbnails/060/605/418/small/default-avatar-profile-icon-social-media-user-free-vector.jpg" alt="Ảnh diễn viên">
            </div>
      ...
      <div class="cw-footer">
        ...
        <button type="submit" class="btn-submit">Lưu diễn viên</button>
      </div>
    </form>
  </div>
</div>
