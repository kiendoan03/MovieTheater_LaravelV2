...
@section('content')
    ...
    <style>
        ...
        .profile-avatar {
            ...
            height: 72px;
            border-radius: 50%;
            background: linear-gradient(135deg, rgba(232, 201, 106, 0.3), rgba(232, 201, 106, 0.08));
            ...
            <div class="page-wrap">
                ...
                <div class="profile-header">
                        ...
                        <div class="profile-meta">
                            @if ($cust?->phonenumber)
                                <span class="meta-chip">
                                    <i class="fa-solid fa-phone"></i> {{ $cust->phonenumber }}
                                </span>
                            @endif
                            @if ($cust?->date_of_birth)
                                <span class="meta-chip">
                                    ...
                                    ({{ \Carbon\Carbon::parse($cust->date_of_birth)->age }} tuổi)
                                </span>
                            @endif
                            @if ($cust?->address)
                                <span class="meta-chip">
                            ...
                            <span class="meta-chip">
                                ...
                                Tham gia {{ $customer->created_at->format('d/m/Y') }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="profile-actions">
                        ...
                        @endif
                        <a href="{{ route('admin.accounts.customer.edit', $customer->id) }}" class="btn-edit-profile">
                ...
                <div class="section-card">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-item-value">{{ $customer->created_at->format('H:i · d/m/Y') }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-item-label">Cập nhật lần cuối</div>
                            <div class="info-item-value">{{ $customer->updated_at->format('H:i · d/m/Y') }}</div>
                        </div>
                    </div>
                </div>
                ...
                {{-- ── Ticket history ── --}}
                <div class="section-card">
                    <div class="section-label">Lịch sử đặt vé ({{ $totalTickets }})</div>
